...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_svgNamespace="http://www.w3.org/2000/svg",_require=require("../../core/Utils"),getETA=_require.getETA,getSpeed=_require.getSpeed,prettyETA=_require.prettyETA,getFileNameAndExtension=_require.getFileNameAndExtension,truncateString=_require.truncateString,copyToClipboard=_require.copyToClipboard,prettyBytes=require("prettier-bytes"),FileItemProgress=require("./FileItemProgress"),getFileTypeIcon=require("./getFileTypeIcon"),_require2=require("./icons"),iconEdit=_require2.iconEdit,iconCopy=_require2.iconCopy,iconRetry=_require2.iconRetry;module.exports=function(e){var t,r,i,s,n,a,p,o,l,d,c,u,m,b,g,A,y,h,E,_,v,C,S,I,f,U,F,D=e.file,q=e.acquirers,N=D.progress.preprocess||D.progress.postprocess,w=D.progress.uploadComplete&&!N&&!D.error,T=D.progress.uploadStarted||N,k=D.progress.uploadStarted&&!D.progress.uploadComplete||N,L=D.isPaused||!1,x=D.error||!1,P=getFileNameAndExtension(D.meta.name)[0],R=e.isWide?truncateString(P,15):P,B=function(t){if(!w)return x?void e.retryUpload(D.id):void(e.resumableUploads?e.pauseUpload(D.id):e.cancelUpload(D.id))};return l=document.createElement("li"),l.setAttribute("id","uppy_"+String(D.id)),l.setAttribute("title",""+String(D.meta.name)),l.setAttribute("class","UppyDashboardItem\n                        "+String(k?"is-inprogress":"")+"\n                        "+String(N?"is-processing":"")+"\n                        "+String(w?"is-complete":"")+"\n                        "+String(L?"is-paused":"")+"\n                        "+String(x?"is-error":"")+"\n                        "+String(e.resumableUploads?"is-resumable":"")),_appendChild(l,[" ",(s=document.createElement("div"),s.setAttribute("class","UppyDashboardItem-preview"),_appendChild(s,[" ",(t=document.createElement("div"),t.setAttribute("style","background-color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),t.setAttribute("class","UppyDashboardItem-previewInnerWrap"),_appendChild(t,[" ",D.preview?(d=document.createElement("img"),d.setAttribute("alt",""+String(D.name)),d.setAttribute("src",""+String(D.preview)),d):(A=document.createElement("div"),A.setAttribute("class","UppyDashboardItem-previewIconWrap"),_appendChild(A,[" ",(c=document.createElement("span"),c.setAttribute("style","color: "+String(getFileTypeIcon(D.type.general,D.type.specific).color)),c.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(c,[getFileTypeIcon(D.type.general,D.type.specific).icon]),c)," ",(g=document.createElementNS(_svgNamespace,"svg"),g.setAttribute("width","72"),g.setAttribute("height","93"),g.setAttribute("viewBox","0 0 72 93"),g.setAttribute("class","UppyDashboardItem-previewIconBg"),_appendChild(g,[(b=document.createElementNS(_svgNamespace,"g"),_appendChild(b,[(u=document.createElementNS(_svgNamespace,"path"),u.setAttribute("d","M24.08 5h38.922A2.997 2.997 0 0 1 66 8.003v74.994A2.997 2.997 0 0 1 63.004 86H8.996A2.998 2.998 0 0 1 6 83.01V22.234L24.08 5z"),u.setAttribute("fill","#FFF"),u),(m=document.createElementNS(_svgNamespace,"path"),m.setAttribute("d","M24 5L6 22.248h15.007A2.995 2.995 0 0 0 24 19.244V5z"),m.setAttribute("fill","#E4E4E4"),m)]),b)]),g)," "]),A)," "]),t)," ",(i=document.createElement("div"),i.setAttribute("class","UppyDashboardItem-progress"),_appendChild(i,[" ",(r=document.createElement("button"),r.setAttribute("type","button"),r.setAttribute("title",""+String(w?"upload complete":e.resumableUploads?D.isPaused?"resume upload":"pause upload":"cancel upload")),r.onclick=B,r.setAttribute("class","UppyDashboardItem-progressBtn"),_appendChild(r,[" ",x?iconRetry():FileItemProgress({progress:D.progress.percentage,fileID:D.id})," "]),r)," ",e.showProgressDetails?(y=document.createElement("div"),y.setAttribute("title",""+String(e.i18n("fileProgress"))),y.setAttribute("aria-label",""+String(e.i18n("fileProgress"))),y.setAttribute("class","UppyDashboardItem-progressInfo"),_appendChild(y,[" ",D.isPaused||w?null:(h=document.createElement("span"),_appendChild(h,[prettyETA(getETA(D.progress))," ・ ↑ ",prettyBytes(getSpeed(D.progress)),"/s"]),h)," "]),y):null," "]),i)," "]),s)," ",(p=document.createElement("div"),p.setAttribute("class","UppyDashboardItem-info"),_appendChild(p,[" ",(n=document.createElement("h4"),n.setAttribute("title",""+String(P)),n.setAttribute("class","UppyDashboardItem-name"),_appendChild(n,[" ",D.uploadURL?(E=document.createElement("a"),E.setAttribute("href",""+String(D.uploadURL)),E.setAttribute("target","_blank"),_appendChild(E,[" ",D.extension?R+"."+D.extension:R," "]),E):D.extension?R+"."+D.extension:R," "]),n)," ",(a=document.createElement("div"),a.setAttribute("class","UppyDashboardItem-status"),_appendChild(a,[" ",D.data.size&&(_=document.createElement("div"),_.setAttribute("class","UppyDashboardItem-statusSize"),_appendChild(_,[prettyBytes(D.data.size)]),_)," ",D.source&&(v=document.createElement("div"),v.setAttribute("class","UppyDashboardItem-sourceIcon"),_appendChild(v,[" ",q.map(function(t){var r;if(t.id===D.source)return r=document.createElement("span"),r.setAttribute("title",String(e.i18n("fileSource"))+": "+String(t.name)),_appendChild(r,[t.icon()]),r})," "]),v)," "]),a)," ",T?null:(C=document.createElement("button"),C.setAttribute("type","button"),C.setAttribute("aria-label","Edit file"),C.setAttribute("title","Edit file"),C.onclick=function(t){return e.showFileCard(D.id)},C.setAttribute("class","UppyDashboardItem-edit"),_appendChild(C,[" ",iconEdit()]),C)," ",D.uploadURL?(S=document.createElement("button"),S.setAttribute("type","button"),S.setAttribute("aria-label","Copy link"),S.setAttribute("title","Copy link"),S.onclick=function(){copyToClipboard(D.uploadURL,e.i18n("copyLinkToClipboardFallback")).then(function(){e.log("Link copied to clipboard."),e.info(e.i18n("copyLinkToClipboardSuccess"),"info",3e3)}).catch(e.log)},S.setAttribute("class","UppyDashboardItem-copyLink"),_appendChild(S,[iconCopy()]),S):null," "]),p)," ",(o=document.createElement("div"),o.setAttribute("class","UppyDashboardItem-action"),_appendChild(o,[" ",w?null:(F=document.createElement("button"),F.setAttribute("type","button"),F.setAttribute("aria-label","Remove file"),F.setAttribute("title","Remove file"),F.onclick=function(){return e.removeFile(D.id)},F.setAttribute("class","UppyDashboardItem-remove"),_appendChild(F,[" ",(U=document.createElementNS(_svgNamespace,"svg"),U.setAttribute("width","22"),U.setAttribute("height","21"),U.setAttribute("viewBox","0 0 18 17"),U.setAttribute("class","UppyIcon"),_appendChild(U,[" ",(I=document.createElementNS(_svgNamespace,"ellipse"),I.setAttribute("cx","8.62"),I.setAttribute("cy","8.383"),I.setAttribute("rx","8.62"),I.setAttribute("ry","8.383"),I)," ",(f=document.createElementNS(_svgNamespace,"path"),f.setAttribute("stroke","#FFF"),f.setAttribute("fill","#FFF"),f.setAttribute("d","M11 6.147L10.85 6 8.5 8.284 6.15 6 6 6.147 8.35 8.43 6 10.717l.15.146L8.5 8.578l2.35 2.284.15-.146L8.65 8.43z"),f)," "]),U)," "]),F)," "]),o)," "]),l};
